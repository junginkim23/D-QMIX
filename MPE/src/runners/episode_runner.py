...
class EpisodeRunner:
    ...
    def run(self, test_mode=False):
        ...
        while not terminated:
            ...
            if hasattr(self.env, 'world') and self.env.world.scenario_name in ['simple_tag', 'simple_adversary', 'simple_crypto', 'simple_world']:
            ...
            if hasattr(self.env, 'world'): # self.env가 'world'라는 특성을 가지고 있으면 True를 반환하게 하는 함수 -> hasattr
                if self.env.world.scenario_name in ['simple_tag', 'simple_world']:
